...
<svelte:head>
	...
	<meta
		name="description"
		content="Play multiplayer {gameName} for free! Ad-free and no registration required."
	/>
...
<div id="content">
	...
	<div id="header">
		<div id="headerLogoContainer">
			...
			>
				...
				<svg height="48" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
					<path d="m0 0h28v28h-28v-28m10 13h-2v2h2v-2m-4 9h16v-16h-16v16m0.5-15.5h15v15h-15v-15"
					></path>
					<path
		...
		<div id="headerIconContainer" class="itemContainer smallItemContainer">
			...
			>
				<svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
					><path d="m0 18v-11h5.75v11m0.5 0v-16h5.5v16m0.5-6h5.75v6h-5.75v-6" /></svg
				>
			</button>
			<button
				id="schedulesButton"
			...
			<button id="loginButton" type="button" class="unselectable" data-i18n="[html]account.login"
				>Login</button
			>
	...
	<div id="layout">
					...
					<div id="leftControls">
						...
						>
							<svg
								...
								/><path
									d="m9 4a1 1 90 0 0 0 5 1 1 90 0 0 0-5m-4 13c0-5 1-7 4-7s4 2 4 7q-4 2-8 0"
								/></svg
							>
						</button><button
							id="saveButton"
							class="iconButton unselectable"
							data-i18n="[title]tooltips.save"
						>
							<svg
								viewBox="0 0 18 18"
								fill="none"
						...
						>
							<svg
								...
								height="24"
								><path
									d="m0 7h3l4-4v12l-4-4h-3v-4m10 0q1 2 0 4m3-5.5q2 3.5 0 7m3-9.5q4 6 0 12"
								/><path d="m-2 16l22-14" /></svg
							>
						</button><button
							...
							<div class="messageContents">
								...
								<div class="globalCooldownIcon icon hidden">
									<svg
										...
										width="18"
										height="18"
										><circle class="bgCircle" cx="9" cy="9" r="9" /><circle
											class="timerCircle"
											cx="9"
											cy="9"
											r="9"
				...
				<div id="joystick" class="unselectable hidden">
					...
					>
						<g id="dpadCircle" transform="translate(-11.225154,-3.5548219)">
							...
							/>
							<path
								d="m 19.681486,8.3276571 h -3.682979 v 3.6834959 h 3.682979 z"
								class="joystickDpad"
							/>
							<path
			...
			<div id="chatbox" class="allChat">
				<div id="chatboxInfo">
					<div id="onlineInfo" class="info hidden">
						...
						><span id="playerCountLabel" class="playerCountLabel infoLabel unselectable"
						></span><span
				...
				<div id="chatboxContent">
					<div id="chatboxTabs">
						<div id="chatboxTabChat" class="chatboxTab active" data-tab-section="chat">
							<label class="chatboxTabLabel unselectable" data-i18n="[html]chatbox.tab.chat"
								>Chat</label
							>
						...
						<div id="chatboxTabPlayers" class="chatboxTab" data-tab-section="players">
							...
							>
							<div
								id="incomingFriendRequestCountContainer"
								class="notificationCountContainer hidden"
							>
								<div class="notificationCount">
									<label class="notificationCountLabel">0</label>
								</div>
							...
							<div id="chatButtons" class="tabButtons">
								...
								>
									<svg
										...
										height="15"
									>
										<path d="m9 0a1 1 0 0 0 0 18 1 1 0 0 0 0-18m0 3v6l4 4" /><path
											d="m-2 16l22-14"
										/>
									</svg>
								</button>
				...
				<div id="enterNameContainer">
					<span id="enterNameInstruction">
						...
						<br />
						<small>
							<span data-i18n="[html]chatbox.chat.nickname.rule.maxLength"
		...
		<div id="modalContainer" class="modalContainer hidden">
			<div id="loginModal" class="modal hidden">
						...
						<ul class="formControls">
							<li class="formControlRow">
								<label
									for="loginUsername"
									class="unselectable"
									data-i18n="[html]modal.login.fields.username">Username</label
								><input
									id="loginUsername"
									name="user"
									type="text"
							...
							<li class="formControlRow">
								<label
									for="loginPassword"
									class="unselectable"
									data-i18n="[html]modal.login.fields.password">Password</label
				...
				<div class="modalFooter">
					<span class="infoLabel" data-i18n="[html]modal.login.registerPrompt"
						>Don't have an account?&nbsp;</span
					><a
						id="loginRegisterLink"
						href="javascript:void(0);"
						data-i18n="[html]modal.login.register">Register</a
					>
				</div>
			</div>
			<div id="registerModal" class="modal hidden">
                  ...
                  <label for="registerEmail" class="unselectable" data-i18n="[html]modal.register.fields.email">Email</label><input id="registerEmail" type="text" autocomplete="off" />
							...
							<li class="formControlRow">
								<label
									...
									class="unselectable"
									data-i18n="[html]modal.register.fields.username">Username</label
								><input
									id="registerUsername"
									name="user"
									type="text"
							...
							<li class="formControlRow">
								<label
									...
									class="unselectable"
									data-i18n="[html]modal.register.fields.password">Password</label
								><input
									id="registerPassword"
									name="password"
									type="password"
							...
							<li class="formControlRow">
								<label
									...
									class="unselectable"
									data-i18n="[html]modal.register.fields.confirmPassword">Confirm Password</label
								><input
				...
				<div class="modalFooter">
					<span class="infoLabel" data-i18n="[html]modal.register.loginPrompt"
						>Already have an account?&nbsp;</span
					><a
						href="javascript:void(0);"
						onclick={() => openModal('loginModal')}
						data-i18n="[html]modal.register.login">Login</a
					>
				</div>
			</div>
			<div id="settingsModal" class="modal hidden">
				...
				<div class="modalContent">
					<ul class="formControls">
						<li class="formControlRow">
							<label for="lang" class="unselectable" data-i18n="[html]modal.settings.fields.lang"
								>Language</label
							>
							<div>
								...
								<label
									id="noGameLocInstruction"
									class="hidden"
									data-i18n="[html]instruction.noGameLoc">* Game Localization Unsupported</label
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								for="nametagMode"
								class="unselectable"
								data-i18n="[html]modal.settings.fields.nametagMode.label">Nametags</label
							>
							<div>
								<select id="nametagMode" size="4">
									<option value="0" data-i18n="[html]modal.settings.fields.nametagMode.values.none"
										>None</option
									>
									<option
										value="1"
										data-i18n="[html]modal.settings.fields.nametagMode.values.classic"
										selected>Classic</option
									>
									<option
										value="2"
										data-i18n="[html]modal.settings.fields.nametagMode.values.compact"
										>Compact</option
									>
									<option value="3" data-i18n="[html]modal.settings.fields.nametagMode.values.slim"
										>Slim</option
									>
								</select>
							</div>
						...
						<li class="formControlRow">
							<label
								for="wikiLinkMode"
								class="unselectable"
								data-i18n="[html]modal.settings.fields.wikiLinkMode.label">Wiki Link Popup</label
							>
							<div>
								<select id="wikiLinkMode" size="3">
									<option value="2" data-i18n="modal.settings.fields.wikiLinkMode.values.always"
										>Always</option
									>
									<option
										value="1"
										data-i18n="modal.settings.fields.wikiLinkMode.values.fullscreen"
										selected>Fullscreen Only</option
									>
									<option value="0" data-i18n="modal.settings.fields.wikiLinkMode.values.never"
										>Never</option
									>
								</select>
							</div>
						...
						<li class="formControlRow">
							<label
								...
								>Save Notification Interval</label
							>
							<div>
								<select id="saveReminder" size="4">
									<option
										...
										i18n-options={{ interval: 10 }}>10 minutes</option
									>
									<option
										value="15"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 15 }}>15 minutes</option
									>
									<option
										value="20"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 20 }}>20 minutes</option
									>
									<option
										value="30"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 30 }}>30 minutes</option
									>
									<option
										value="45"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 45 }}>45 minutes</option
									>
									<option
										value="60"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 60 }}>60 minutes</option
									>
									<option
										value="90"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 90 }}>90 minutes</option
									>
									<option
										value="120"
										data-i18n="modal.settings.fields.saveReminder.interval.minutes"
										i18n-options={{ interval: 120 }}>120 minutes</option
									>
									<option value="0" data-i18n="modal.settings.fields.saveReminder.interval.never"
										>Never</option
									>
								</select>
							</div>
						...
						<li class="formControlRow">
							<label
								for="soundVolume"
								class="unselectable"
								data-i18n="[html]modal.settings.fields.soundVolume">Sound Volume</label
							>
							<div>
								<input
									id="soundVolume"
						...
						<li class="formControlRow">
							<label
								for="musicVolume"
								class="unselectable"
								data-i18n="[html]modal.settings.fields.musicVolume">Music Volume</label
							>
							<div>
								<input
									id="musicVolume"
						...
						<li class="formControlRow">
							...
							>
							<div>
								<button id="playerSoundsButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label class="unselectable">
								<span data-i18n="[html]modal.settings.fields.toggleEnableBadgeHints.label"
									>Badge Hints</span
								>
								<a
									href="javascript:void(0);"
							...
							<div>
								<button id="badgeHintsButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow indent badgeHintRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.settings.fields.togglePlayBadgeHintSound"
								>Play Badge Hint Sound</label
							>
							<div>
								<button
									id="playBadgeHintSoundButton"
									class="checkboxButton inverseToggle unselectable"><span></span></button
								>
							</div>
						</li>
						{#if gameId == '2kki'}
							<li class="formControlRow">
								<label class="unselectable">
									<span data-i18n="[html]modal.settings.fields.toggleEnableExplorer.label"
										>Navigator</span
									>
									<a
										href="javascript:void(0);"
								...
								<div>
									<button id="enableExplorerButton" class="checkboxButton unselectable"
										><span></span></button
									>
								</div>
							</li>
						...
						<li class="formControlRow">
							<label class="unselectable">
								<span data-i18n="[html]modal.settings.fields.toggleImmersionMode.label"
									>Immersion Mode</span
								>
								<a
									href="javascript:void(0);"
							...
							<div>
								<button id="immersionModeButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label class="unselectable">
								<span data-i18n="[html]modal.settings.fields.toggleSingleplayerMode.label"
									>Singleplayer Mode</span
								>
								<a
									href="javascript:void(0);"
									class="helpLink iconLink"
							...
							<div>
								<button id="singleplayerModeButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow mobileOnly">
							<label
								class="unselectable"
								data-i18n="[html]modal.settings.fields.toggleMobileControls"
								>Show Mobile Controls</label
							>
							<div>
								<button id="mobileControlsButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow mobileOnly">
							<label class="unselectable">
								<span data-i18n="[html]modal.settings.fields.mobileControlsType.label"
									>Mobile Controls Type</span
								>
								<a
									href="javascript:void(0);"
									class="helpLink iconLink"
							...
							<div>
								<select id="mobileControl" size="3">
									<option
										value="default"
										selected
										data-i18n="[html]modal.settings.fields.mobileControlsType.default">D-Pad</option
									>
									<option
										value="joystick"
										data-i18n="[html]modal.settings.fields.mobileControlsType.joystick"
										>Floating Joystick</option
									>
									<option
										value="dpad"
										data-i18n="[html]modal.settings.fields.mobileControlsType.dpad"
										>Floating D-Pad</option
									>
								</select>
							</div>
						</li>
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.settings.fields.toggleLocationDisplay"
								>Location Display</label
							>
							<div>
								<button id="locationDisplayButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label class="unselectable" data-i18n="[html]modal.settings.fields.toggleRankings"
								>Rankings</label
							>
							<div>
								<button id="toggleRankingsButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label class="unselectable" data-i18n="[html]modal.settings.fields.toggleSchedules"
								>Events</label
							>
							<div>
								<button id="toggleSchedulesButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							...
							<div>
								<button id="togglePreloadsButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
							...
							<li class="formControlRow indent preloadRow hidden">
								<label class="unselectable">
									<span data-i18n="[html]modal.settings.fields.toggleQuestionablePreloads"
										>Preload PC Wallpapers</span
									>
								</label>
								<div>
									<button id="toggleQuestionablePreloadsButton" class="checkboxButton unselectable"
										><span></span></button
									>
								</div>
							</li>
						...
						<li class="formControlRow">
							...
							<div>
								<button id="toggleUnicodeFont" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.settings.fields.toggleHideUnnamedPlayers"
								>Hide Unnamed Players</label
							>
							<div>
								<button id="hideUnnamedPlayersButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow buttonRow">
							<button
								...
								class="unselectable"
								type="button"
								data-i18n="[html]modal.settings.blocklist">Blocklist</button
							>
							<button
								...
								onclick={() => openModal('chatSettingsModal', null, 'settingsModal')}>Chat</button
							>
							<button
							...
							<button
								...
								onclick={() => openCacheSettingsModal('settingsModal')}>Cache</button
							>
							<button
								id="accountSettingsButton"
								class="unselectable accountRequired"
								type="button"
								data-i18n="[html]modal.settings.accountSettings">Account</button
							>
							<button
								class="unselectable"
								type="button"
								data-i18n="[html]modal.settings.engineSettings"
								onclick={() => (closeModal(), simulateKeyboardInput('F1', 112))}>Engine (F1)</button
							>
						</li>
					</ul>
				</div>
			...
			<div id="blocklistModal" class="modal hidden">
				...
				<div class="modalContent">
					<span
						id="blocklistModalEmptyLabel"
						class="infoLabel"
						data-i18n="[html]modal.blocklist.empty">Your blocklist is currently empty</span
					>
				...
				<div class="modalContent">
					<ul class="formControls">
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.toggleGameChat.label"
								>In-Game Chat Overlay</label
							>
							<div>
								<button id="gameChatButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow indent gameChatRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.toggleGameChat.global"
								>Global Chat Overlay</label
							>
							<div>
								<button id="gameChatGlobalButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow indent gameChatRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.toggleGameChat.party"
								>Party Chat Overlay</label
							>
							<div>
								<button id="gameChatPartyButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow desktopOnly">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.toggleTabToChat">Press Tab to Chat</label
							>
							<div>
								<button id="tabToChatButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.togglePlayMentionSound"
								>Play Mention Sound</label
							>
							<div>
								<button
						...
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.chatSettings.fields.blurScreenshotEmbeds"
								>Blur All Screenshots</label
							>
							<div>
								<button id="blurScreenshotEmbedsButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								...
								>Map Chat History Limit</label
							>
							<div>
								<select id="mapChatHistoryLimit">
									<option
										value="25"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.25"
										>25</option
									>
									<option
										value="50"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.50"
										>50</option
									>
									<option
										value="100"
									...
									<option
										value="500"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.500"
										>500</option
									>
									<option
										value="1000"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.1000"
										>1000</option
									>
									<option
										value="2500"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.2500"
										>2500</option
									>
									<option
										value="0"
										data-i18n="[html]modal.chatSettings.fields.chatHistoryLimit.values.0"
										>Unlimited</option
									>
								</select>
							</div>
						...
						<li class="formControlRow">
							<label
								...
								>Global Chat History Limit</label
							>
							<div>
			...
			<div id="screenshotSettingsModal" class="modal hidden">
				<a href="javascript:void(0);" class="modalClose">✖</a>
				<div class="modalHeader">
					<h1 class="modalTitle" data-i18n="[html]modal.screenshotSettings.title">
						Screenshot Settings
					</h1>
				</div>
				<div class="modalContent">
					<ul class="formControls">
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.screenshotSettings.fields.autoDownloadScreenshots"
								>Automatically Download Screenshots</label
							>
							<div>
								<button id="autoDownloadScreenshotsButton" class="checkboxButton unselectable"
									><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								for="screenshotResolution"
								class="unselectable"
								data-i18n="[html]modal.screenshotSettings.fields.screenshotResolution.label"
								>Screenshot Download Resolution</label
							>
							<div>
								<select id="screenshotResolution">
									<option
										value="1"
										data-i18n="[html]modal.screenshotSettings.fields.screenshotResolution.values.1"
										selected>1x - 320x240</option
									>
									<option
										value="2"
										data-i18n="[html]modal.screenshotSettings.fields.screenshotResolution.values.2"
										>2x - 640x480</option
									>
									<option
										value="3"
										data-i18n="[html]modal.screenshotSettings.fields.screenshotResolution.values.3"
										>3x - 960x720</option
									>
									<option
										value="4"
										data-i18n="[html]modal.screenshotSettings.fields.screenshotResolution.values.4"
										>4x - 1280x960</option
									>
								</select>
							</div>
				...
				<div class="modalContent">
					<ul class="formControls">
						<li class="formControlRow">
							...
							>
							<div>
								<button id="notificationsButton" class="checkboxButton inverseToggle unselectable"
									><span></span></button
								>
							</div>
						</li>
			...
			<div id="cacheSettingsModal" class="modal hidden">
				...
				<div class="modalContent">
					<ul class="formControls" style="overflow: visible">
						<li class="formControlRow">
							<label class="unselectable" data-i18n="[html]modal.cacheSettings.fields.locationCache"
								>Location Cache</label
							>
							<div>
								<button
									type="button"
									id="clearLocationCacheButton"
									class="unselectable"
									data-i18n="[html]modal.cacheSettings.clear"
									onclick={() => clearCache(CACHE_TYPE.location, this)}>Clear</button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label class="unselectable" data-i18n="[html]modal.cacheSettings.fields.mapCache"
								>Map Cache</label
							>
							<div>
								<button
									...
									class="unselectable"
									data-i18n="[html]modal.cacheSettings.clear"
									onclick={() => clearCache(CACHE_TYPE.map, this)}>Clear</button
								>
							</div>
						</li>
						<li class="formControlRow">
							<label
								class="unselectable"
								data-i18n="[html]modal.cacheSettings.fields.locationColorCache"
								>Location Color Cache</label
							>
							<div>
								<button
									type="button"
									id="clearLocationColorCacheButton"
									class="unselectable"
									data-i18n="[html]modal.cacheSettings.clear"
									onclick={() => clearCache(CACHE_TYPE.locationColor, this)}>Clear</button
								>
							</div>
						</li>
					</ul>
					...
					<ul class="formControls">
						<li class="formControlRow buttonRow">
							<button
								...
								class="unselectable"
								type="button"
								data-i18n="[html]modal.accountSettings.fields.changePassword"
								>Change Password</button
							>
						</li>
						<li class="formControlRow">
							<label
								for="accountBadgeButton"
								class="unselectable"
								data-i18n="[html]modal.accountSettings.fields.badge">Badge</label
							>
							<div>
						...
						<li id="saveSyncSlotIdRow" class="formControlRow buttonRow">
							<button
								id="clearSaveSyncButton"
								class="unselectable"
								type="button"
								data-i18n="[html]modal.accountSettings.fields.clearSaveSync"
								>Clear Save Sync Data</button
							>
						</li>
					</ul>
				</div>
						...
						<ul class="formControls">
							<li class="formControlRow">
								<label
									for="oldPassword"
									class="unselectable"
									data-i18n="[html]modal.password.fields.oldPassword">Old Password</label
								><input id="oldPassword" name="password" type="password" autocomplete="off" />
							</li>
							<li class="formControlRow">
								<label
									for="newPassword"
									class="unselectable"
									data-i18n="[html]modal.password.fields.newPassword">New Password</label
							...
							<li class="formControlRow">
								<label
									for="confirmPassword"
									class="unselectable"
									data-i18n="[html]modal.password.fields.newConfirmPassword"
									>Confirm New Password</label
								><input id="newConfirmPassword" type="password" autocomplete="off" />
							</li>
			...
			<div id="badgesModal" class="modal fullscreenModal hidden">
					...
					<div id="badgeControls" class="uiControls wrap">
						<div class="uiControl">
							<label
								...
								class="unselectable"
								data-i18n="[html]modal.badges.fields.unlockStatus.label">Unlock Status:&nbsp;</label
							>
							<select id="badgeUnlockStatus">
								<option value="" data-i18n="[html]modal.badges.fields.unlockStatus.values.all"
									>All</option
								>
								<option value="0" data-i18n="[html]modal.badges.fields.unlockStatus.values.0"
									>Locked</option
								>
								<option value="1" data-i18n="[html]modal.badges.fields.unlockStatus.values.1"
									>Unlocked</option
								>
								<option
									value="recentUnlock"
									data-i18n="[html]modal.badges.fields.unlockStatus.values.recentUnlock"
									>Recently Unlocked</option
								>
							</select>
						</div>
						<div class="uiControl">
							<label
								for="badgeSortOrder"
								class="unselectable"
								data-i18n="[html]modal.badges.fields.sortOrder.label">Sort Order:&nbsp;</label
							>
							<select id="badgeSortOrder">
								<option value="" data-i18n="[html]modal.badges.fields.sortOrder.values.default"
									>Default</option
								>
							</select>
						</div>
						<div class="uiControl">
							<label
								for="badgeSearch"
								class="unselectable"
								data-i18n="[html]modal.badges.fields.search.label">Search:&nbsp;</label
							>
							<div style="display: inline-block">
								<svg
									data-kind="name"
									class="icon searchIcon hidden"
									height="24px"
									viewBox="0 0 24 24"
									fill="none"
									xmlns="http://www.w3.org/2000/svg"
							...
							<a id="badgeSearchClearLink" href="javascript:void(0);" class="unselectable hidden"
								>✖</a
							>
						</div>
					</div>
				...
				<div class="modalFooter">
					<button
						...
						class="unselectable"
						type="button"
						data-i18n="[html]modal.badges.manageBadgeGallery">Manage Badge Gallery</button
					>
					{#if enableBadgeTools}
			...
			<div id="badgeGalleryModal" class="modal semiWideModal hidden">
				<a href="javascript:void(0);" class="modalClose">✖</a>
				<div class="modalHeader">
					<h1 class="modalTitle" data-i18n="[html]modal.badgeGallery.title">
				...
				<div class="modalFooter">
					<button
						...
						class="unselectable"
						type="button"
						data-i18n="[html]modal.badgeGallery.removeMode.activate">Remove Badges</button
					>
					<button
						id="badgePresetButton"
						class="unselectable"
						type="button"
						data-i18n="[html]modal.badgeGallery.manageBadgePreset">Manage Presets</button
					>
				</div>
			</div>
			<div id="badgePresetModal" class="modal hidden">
				...
				<div class="modalHeader">
					...
					<div class="formControls" style="width:100%">
						<div class="formControlRow">
							<label for="badgePresetSelection" data-i18n="[html]modal.badgePreset.selectPreset"
								>Select Preset</label
							>
							<select id="badgePresetSelection">
								<option
									value="0"
									data-i18n="[html]modal.badgePreset.presetName"
									i18n-options={{ index: 1 }}>Preset 1</option
								>
								<option
									value="1"
									data-i18n="[html]modal.badgePreset.presetName"
									i18n-options={{ index: 2 }}>Preset 2</option
								>
								<option
									value="2"
									data-i18n="[html]modal.badgePreset.presetName"
									i18n-options={{ index: 3 }}>Preset 3</option
								>
							</select>
						</div>
					</div>
				...
				<div class="modalFooter">
					<button
						...
						class="unselectable"
						type="button"
						data-i18n="[html]modal.common.save">Save</button
					>
					<button
						id="badgePresetLoad"
						class="unselectable"
						type="button"
						data-i18n="[html]modal.common.apply">Apply</button
					>
				</div>
			</div>
			<div id="uiThemesModal" class="modal fullscreenModal hidden">
				...
				<div class="modalFooter">
					<div class="uiControl">
						<label for="fontStyle" class="unselectable" data-i18n="[html]fontStyle.label"
							>Font Style:</label
						>
			...
			<div id="saveModal" class="modal wideModal hidden">
				...
				<div class="modalHeader">
					<h1 class="modalTitle">
						<span data-i18n="[html]modal.save.title"> Manage Save Data </span>
						<a
							href="javascript:void(0);"
							class="helpLink iconLink"
							data-i18n="[title]modal.save.info"
						>
							<div class="helpIcon icon fillIcon invertFillIcon altIcon">
								<svg viewBox="0 0 18 18">
									<path
				...
				<div class="modalContent">
					<div id="saveSlotList" class="scrollableContainer"></div>
				</div>
				<div class="modalFooter">
					<button
						id="saveModalManageOtherButton"
						type="button"
						data-i18n="[html]modal.save.manageOther">Manage Different Game&hellip;</button
					>
					<select id="saveDataGame" class="gameSelect hidden"> </select>
					<button
						id="saveModalReloadButton"
						class="unselectable hidden"
						type="button"
						data-i18n="[html]modal.save.reload">Save Changes and Reload</button
					>
				</div>
			</div>
			<div id="createPartyModal" class="modal hidden">
				...
				<div class="modalHeader">
					<h1 class="modalTitle">
						<span class="createTitle" data-i18n="[html]modal.createParty.title.create"
							>Create Party</span
						>
						<span class="updateTitle" data-i18n="[html]modal.createParty.title.update"
							>Update Party</span
						>
					</h1>
				</div>
						...
						<ul class="formControls">
							<li class="formControlRow">
								<label
									for="partyName"
									class="unselectable"
									data-i18n="[html]modal.createParty.fields.partyName">Party Name</label
								><input id="partyName" name="name" type="text" autocomplete="off" />
							</li>
							<li class="formControlRow">
								<div class="textareaContainer">
									<label
										...
										class="unselectable"
										data-i18n="[html]modal.createParty.fields.description">Description</label
									>
									<textarea id="partyDescription" name="description" class="autoExpand"></textarea>
								</div>
							</li>
							<li class="formControlRow">
								<label class="unselectable" data-i18n="[html]modal.createParty.fields.public"
									>Public</label
								>
								<div>
									<button
										id="publicPartyButton"
										class="checkboxButton inverseToggle unselectable"
								...
								<div>
									...
									<div>
										<label
											for="partyPassword"
											class="unselectable"
											data-i18n="[html]modal.createParty.fields.password">Password</label
										><input id="partyPassword" name="pass" type="password" autocomplete="off" />
									</div>
								</div>
							</li>
							<li class="formControlRow">
								<label
									for="partyThemeButton"
									class="unselectable"
									data-i18n="[html]modal.createParty.fields.theme">Theme</label
								>
								<div>
			...
			<div id="joinPrivatePartyModal" class="modal hidden">
				<a href="javascript:void(0);" class="modalClose">✖</a>
				<div class="modalHeader">
					<h1 class="modalTitle" data-i18n="[html]modal.joinPrivateParty.title">
						Join Private Party
					</h1>
				</div>
				<div class="modalContent">
					<form id="joinPrivatePartyForm">
						<ul class="formControls">
							<li class="formControlRow">
								<div>
									<a
										id="showHidePrivatePartyPasswordLink"
										href="javascript:void(0);"
										class="showHidePasswordLink"
									>
									...
									<div>
										<label
											for="partyPassword"
											class="unselectable"
											data-i18n="[html]modal.joinPrivateParty.fields.password">Password</label
										><input
											id="privatePartyPassword"
											name="pass"
											type="password"
											autocomplete="off"
										/>
							...
							<li id="joinPrivatePartyFailed" class="formControlRow hidden">
								<label data-i18n="[html]modal.joinPrivateParty.incorrectPassword"
									>Incorrect Password: Please try again.</label
								>
							</li>
						</ul>
				...
				<div class="modalContent">
					<div id="partyModalDescriptionContainer">
						<div class="infoIcon icon fillIcon">
							<svg viewBox="0 0 18 18">
								<path
									d="m9 0a1 1 90 0 0 0 18 1 1 90 0 0 0 -18m-2 15.5v-1q1 0 1-1v-4q0-1-1-1v-1h4v6q0 1 1 1v1m-3-9c-1.625 0-2-1.5-2-2s0.375-2 2-2 2 1.5 2 2-0.375 2-2 2"
								/>
							</svg>
						</div>
				...
				<div class="modalContent">
					...
					<div id="rankExpContainer">
						<label
							id="rankExpLabel"
							class="progressBarHeading"
							data-i18n="[html]modal.events.rankExp">Next Rank</label
						>
					...
					<label id="weekExpLabel" class="progressBarHeading" data-i18n="[html]modal.events.weekExp"
						>ExP This Week</label
					>
					...
					<div id="eventTabs" class="subTabs">
						<div id="eventTabLocations" class="eventTab subTab active" data-tab-list="locations">
							<small
								class="subTabLabel infoLabel unselectable"
								data-i18n="[html]modal.events.tabs.locations">Locations</small
							>
							<div class="subTabBg"></div>
						</div>
						<div id="eventTabVms" class="eventTab subTab" data-tab-list="vms">
							<small
								class="subTabLabel infoLabel unselectable"
								data-i18n="[html]modal.events.tabs.vms">Vending Machine</small
							>
							<div class="subTabBg"></div>
						</div>
					</div>
			...
			<div id="locationsModal" class="modal fullscreenModal hidden">
				...
				<div class="modalHeader">
					...
					<div id="locationsControls" class="uiControls wrap">
						<div class="uiControl">
							...
							<select id="locationsVisited">
								<option value="" data-i18n="[html]modal.locations.fields.visited.values.all"
									>All</option
								>
								<option
									value="visited"
									data-i18n="[html]modal.locations.fields.visited.values.visited">Visited</option
								>
								<option
									value="unvisted"
									data-i18n="[html]modal.locations.fields.visited.values.unvisited"
									>Unvisited</option
								>
							</select>
						</div>
						<div class="uiControl">
							...
							<select id="locationsSortOrder">
								<option
									value="newest"
									data-i18n="[html]modal.locations.fields.sortOrder.values.newest">Newest</option
								>
								<option
									value="oldest"
									data-i18n="[html]modal.locations.fields.sortOrder.values.oldest">Oldest</option
								>
								<option
									value="shallowest"
									data-i18n="[html]modal.locations.fields.sortOrder.values.shallowest"
									>Shallowest</option
								>
								<option
									value="deepest"
									data-i18n="[html]modal.locations.fields.sortOrder.values.deepest">Deepest</option
								>
								<option
									value="alpha"
									data-i18n="[html]modal.locations.fields.sortOrder.values.alpha"
									>Alphabetical</option
								>
								<option
									value="players"
									data-i18n="[html]modal.locations.fields.sortOrder.values.players"
									>Player Count</option
								>
							</select>
						</div>
					...
					<div class="infiniteScrollRefreshIndicator transparent unselectable">
						<label class="infoLabel" data-i18n="[html]modal.locations.scrollToRefresh"
							>Scroll to Top to Refresh</label
						>
					</div>
				</div>
				<div class="modalContent infiniteScrollContainer itemContainer"></div>
			</div>
			<div id="screenshotModal" class="modal fullscreenModal hidden">
				...
				<div class="modalFooter">
					<button
						class="downloadScreenshotButton unselectable"
						type="button"
						data-i18n="[html]modal.screenshot.download">Download</button
					>
					<button
						class="saveScreenshotButton unselectable"
						type="button"
						data-i18n="[html]modal.screenshot.save">Save to My Screenshots</button
					>
					<button
						class="shareScreenshotButton unselectable"
						type="button"
						data-i18n="[html]modal.screenshot.share">Share Screenshot in Chat</button
					>
				</div>
			</div>
			<div id="myScreenshotsModal" class="modal fullscreenModal hidden">
				...
				<div class="modalHeader">
					...
					<div
						id="screenshotSlotProgressContainer"
						class="screenshotSlotProgressContainer progressContainer"
					>
						<label
							id="screenshotSlotProgressLabel"
							class="progressBarHeading"
							data-i18n="[html]modal.myScreenshots.screenshotSlotProgress"
							>Next Slot Upgrade (BP)</label
						>
						<div id="screenshotSlotProgressBarContainer" class="progressBarContainer">
							<label
								id="screenshotSlotProgressBarLabel"
								class="progressBarLabel altText unselectable"
							></label>
					...
					<span
						id="myScreenshotsEmptyLabel"
						class="infoLabel hidden"
						data-i18n="[html]modal.myScreenshots.empty">You haven't saved any screenshots yet.</span
					>
				</div>
				<div class="modalContent itemContainer"></div>
			</div>
			<div id="communityScreenshotsModal" class="modal fullscreenModal hidden">
				<a href="javascript:void(0);" class="modalClose">✖</a>
				<div class="modalHeader">
					<h1 class="modalTitle" data-i18n="[html]modal.communityScreenshots.title">
					...
					<div id="communityScreenshotsControls" class="uiControls wrap">
						<div class="uiControl">
							<label
								...
								class="unselectable"
								data-i18n="[html]modal.communityScreenshots.fields.game.label">Game:&nbsp;</label
							>
						...
						<div class="uiControl">
							...
							<select id="communityScreenshotsSortOrder">
								<option
									value="recent"
									data-i18n="[html]modal.communityScreenshots.fields.sortOrder.values.recent"
									>Newest</option
								>
								<option
									value="likes"
									data-i18n="[html]modal.communityScreenshots.fields.sortOrder.values.likes"
									>Most Liked</option
								>
							</select>
						</div>
						<div class="uiControl">
							...
							<select id="communityScreenshotsInterval">
								<option
									value="day"
									data-i18n="[html]modal.communityScreenshots.fields.interval.values.day"
									>Today</option
								>
								<option
									value="week"
									data-i18n="[html]modal.communityScreenshots.fields.interval.values.week"
									>This Week</option
								>
								<option
									value="month"
									data-i18n="[html]modal.communityScreenshots.fields.interval.values.month"
									>This Month</option
								>
								<option
									value="year"
									data-i18n="[html]modal.communityScreenshots.fields.interval.values.year"
									>This Year</option
								>
								<option
									value=""
									data-i18n="[html]modal.communityScreenshots.fields.interval.values.all"
									>All Time</option
								>
							</select>
						</div>
					...
					<div class="infiniteScrollRefreshIndicator transparent unselectable">
						<label class="infoLabel" data-i18n="[html]modal.communityScreenshots.scrollToRefresh"
							>Scroll to Top to Refresh</label
						>
					</div>
				</div>
			...
			<div id="rulesModal" class="modal hidden">
				...
				<div class="modalContent">
					<ul>
						<li>
							<span data-i18n="[html]modal.rules.rule1">Please be respectful and polite.</span>
						</li>
						<li>
							<span data-i18n="[html]modal.rules.rule2">No 18+ discussion (NSFW, gore, etc.).</span>
						</li>
						<li><span data-i18n="[html]modal.rules.rule3">No politics.</span></li>
						<li>
							<span data-i18n="[html]modal.rules.rule4"
								>No inflammatory remarks (including slurs).</span
							>
						</li>
						<li>
							<span data-i18n="[html]modal.rules.rule5"
								>No cheating of any kind for any reason.</span
							>
						</li>
						<li>
							<span data-i18n="[html]modal.rules.rule6"
								>If there's trouble, please inform the moderators.</span
							>
						</li>
					</ul>
				</div>
			...
			<div id="warningsModal" class="modal hidden">
				...
				<div class="modalHeader">
					...
					<h3 class="modalSubtitle" data-i18n="[html]modal.warnings.subtitle">
				...
				<div class="modalContent">
					<ul>
						<li>
							<span data-i18n="[html]modal.warnings.warning1"
								>Some games contain flashing lights sequences or patterns that may affect
								photosensitive viewers.</span
							>
						</li>
						<li>
							<span data-i18n="[html]modal.warnings.warning2"
								>References to self-harm or suicide.</span
							>
						</li>
						<li><span data-i18n="[html]modal.warnings.warning3">Disturbing imagery.</span></li>
						<li>
							<span data-i18n="[html]modal.warnings.warning4">Depictions of drug use.</span>
						</li>
					</ul>
				</div>
			</div>
			{#if gameId == '2kki'}
				<div id="explorerUndiscoveredLocationsModal" class="modal hidden">
					<a href="javascript:void(0);" class="modalClose">✖</a>
					<div class="modalHeader">
						<h1 class="modalTitle" data-i18n="[html]modal.explorerUndiscoveredLocations.title">
					...
					<div class="modalContent">
						...
						<span
							id="explorerUndiscoveredLocationsEmptyLabel"
							class="infoLabel hidden"
							data-i18n="[html]modal.explorerUndiscoveredLocations.complete"
							>You've discovered every available location! Congrats!!</span
						>
					</div>
				</div>
			{/if}
			...
			<div id="schedulesModal" class="modal hidden">
				...
				<div class="modalContent">
					<div style="width:100%">
						<div
							class="messageContainer themeText scheduleGroupHeader"
							data-i18n="[html]modal.schedule.official"
						>
							Official Events
						</div>
					...
					<div style="width:100%">
						<div
							class="messageContainer themeText scheduleGroupHeader"
							data-i18n="[html]modal.schedule.ongoing"
						>
							Ongoing Events
						</div>
					...
					<div style="width:100%">
						<div
							class="messageContainer themeText scheduleGroupHeader"
							data-i18n="[html]modal.schedule.party"
						>
							Party Events
						</div>
					...
					<div style="width:100%">
						<div
							class="messageContainer themeText scheduleGroupHeader"
							data-i18n="[html]modal.schedule.future"
						>
							Future Events
						</div>
				...
				<template id="scheduleTemplate">
					<div class="listEntry schedule">
						<div class="listEntryMain">
							<strong class="nameMarker eventName" data-role="name">
								<svg width="16" height="16" class="icon fillIcon hidden" data-role="partyIcon">
									<path
										d="m9 4a1 1 90 0 0 0 5 1 1 90 0 0 0 -5m-4 13c0-5 1-7 4-7s4 2 4 7q-4 2-8 0m0-17a1 1 90 0 0 0 5 1 1 90 0 0 0 -5m-4 13c0-5 1-7 4-7 0.375 0 0.5 0 1.25 0.125-0.25 1.625 1.25 3.125 2.5 3.125q0.125 0.25 0.125 0.5c-1.75 0-3.625 1-3.875 4.125q-2.375 0-4-0.875m12-13a1 1 90 0 1 0 5 1 1 90 0 1 0 -5m4 13c0-5-1-7-4-7-0.375 0-0.5 0-1.25 0.125 0.25 1.625-1.25 3.125-2.5 3.125q-0.125 0.25-0.125 0.5c1.75 0 3.625 1 3.875 4.125q2.375 0 4-0.875"
									></path>
								</svg>
							</strong>
							<div class="themeText scheduleHeader">
								<button
									data-role="edit"
									class="icon iconButton fillIcon unselectable hidden toggleButton offToggleButton"
								...
								<div
									data-role="cancel"
									class="deleteIcon icon iconButton hidden"
									style="padding-inline-end: 12px"
								>
								...
								<div class="likeContainer" style=" display: flex; align-items: center;">
									...
									<span
										class="infoLabel likeCount unselectable"
										data-role="followerCount"
										style=" margin-inline-start: 8px; font-size: 1.2em; "
									></span>
								</div>
							</div>
						</div>
						...
						<div class="scheduleDescription">
							<span class="themeText" data-role="description"> </span>
						</div>

						<div style="padding-bottom: 4px; font-size: 0.9em;" data-role="links"></div>

						<div
							style="justify-content: space-between; width: 100%; font-size: 0.9em;"
							class="listEntryMain themeText"
						>
							<div data-role="organizer" style="display:inline-flex; white-space:nowrap"></div>
							<div data-role="datetime" class="scheduleDatetime"></div>
						</div>
					</div>
				</template>
				<div class="modalFooter">
					<button
						...
						data-i18n="[html]modal.schedule.doSchedule">Schedule an Event</button
					>
				</div>
			</div>
						...
						<form id="scheduleForm" action="javascript:void(0)">
							<li class="formControlRow fullWidth">
								<div class="textareaContainer">
									<label
										for="name"
										class="unselectable"
										data-i18n="[html]modal.scheduleEdit.fields.name">Event Name</label
									>
							...
							<li class="formControlRow fullWidth">
								<div class="textareaContainer">
									<label
										for="description"
										class="unselectable"
										data-i18n="[html]modal.scheduleEdit.fields.description">Description</label
									>
									<textarea
							...
							<li class="formControlRow">
								<label
									for="eventStart"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.datetime">Event Date and Time</label
								>
								<div>
							...
							<li id="eventInterval" class="formControlRow indent">
								<label
									for="interval"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.interval.title">Interval</label
								>
								<div>
									<input name="interval" type="number" min="1" value="1" />
									<select name="intervalType">
										<option value="days" data-i18n="[html]modal.scheduleEdit.fields.interval.days"
											>days</option
										>
										<option
											value="months"
											data-i18n="[html]modal.scheduleEdit.fields.interval.months">months</option
										>
							...
							<li id="restrictPartyRow" class="formControlRow">
								<label
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.restrictParty">Limit to Party</label
								>
								<div>
							...
							<li id="resetOrganizerRow" class="formControlRow hidden">
								<label
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.resetOrganizer">Reset Organizer</label
								>
								<div>
							...
							<li class="formControlRow">
								<label
									...
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.theme">Theme</label
								>
								<div>
							...
							<li class="formControlRow">
								<label
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.title">External Links</label
								>
							</li>
							<li class="formControlRow indent">
								<label
									for="discord"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.discord">Discord</label
								>
								<div>
							...
							<li class="formControlRow indent">
								<label
									for="youtube"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.youtube">YouTube</label
								>
								<div>
							...
							<li class="formControlRow indent">
								<label
									for="twitch"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.twitch">Twitch</label
								>
								<div>
							...
							<li class="formControlRow indent">
								<label
									for="niconico"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.niconico">Nicovideo</label
								>
								<div>
							...
							<li class="formControlRow indent">
								<label
									for="openrec"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.openrec">Openrec</label
								>
								<div>
							...
							<li class="formControlRow indent">
								<label
									for="bilibili"
									class="unselectable"
									data-i18n="[html]modal.scheduleEdit.fields.platforms.bilibili">Bilibili</label
								>
								<div>
							...
							<li class="formControlRow buttonRow fullWidth">
								...
								<button
									type="button"
									id="cancelSchedule"
									data-i18n="[html]modal.scheduleEdit.cancel">Cancel Event</button
								>
							</li>
						</form>
					</ul>
						...
						<form id="reportForm" action="javascript:void(0);">
							<li class="formControlRow">
								<label
									for="reason"
									class="unselectable"
									data-i18n="[html]modal.report.fields.reason.title">Reason</label
								>
								<div>
									<select id="reportReasonSelect" value=":1" name="reason">
										<option value=":1" data-i18n="[html]modal.report.fields.reason.1"
											>Slurs, harmful or inappropriate language</option
										>
										<option value=":2" data-i18n="[html]modal.report.fields.reason.2"
											>Harassment, bullying, stalking</option
										>
										<option value=":3" data-i18n="[html]modal.report.fields.reason.3"
											>Inappropriate names</option
										>
										<option value=":4" data-i18n="[html]modal.report.fields.reason.4"
											>Ban evasion</option
										>
										<option value=":5" data-i18n="[html]modal.report.fields.reason.5"
											>Cheating, abusing exploits</option
										>
										<option value=":6" data-i18n="[html]modal.report.fields.reason.6"
											>Underage player</option
										>
										<option value=":7" data-i18n="[html]modal.report.fields.reason.7">Spam</option>
										<option value="" data-i18n="[html]modal.report.fields.reason.other"
							...
							<li id="reportCustomReason" class="formControlRow fullWidth hidden">
								<div class="textareaContainer">
									<input
										...
										data-i18n="[placeholder]modal.report.fields.reason.placeholder"
									/>
								</div>
							</li>
							<li class="formControlRow buttonRow fullWidth">
			...
			<!--<template id="badgeTemplate">
					<div>
						<ul class="formControls flexFormControls">
							<li class="formControlRow fullWidth">
								<label class="unselectable">Badge ID</label><input
									v-model="badgeId"
									type="text"
									autocomplete="off"
								/>
							...
							<li class="formControlRow">
								...
								<select v-model="gameId">
									<option :value="gameOption.key" v-for="gameOption in gameOptions"
										>[[gameOption.label]]</option
									>
								</select>
							</li>
							<li class="formControlRow" v-if="groupOptions.length">
								...
								<select v-model="group">
									<option :value="groupOption.key" v-for="groupOption in groupOptions"
							...
							<li class="formControlRow">
								<label class="unselectable">Badge Name</label><input
									v-model="name"
									type="text"
									autocomplete="off"
								/>
							...
							<li class="formControlRow">
								<label class="unselectable">Artist</label><input
									v-model="art"
									type="text"
									autocomplete="off"
								/>
							...
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (animated = !animated)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
							...
							<li
								class="formControlRow fullWidth"
								v-if="reqType === 'tags' || reqType === 'tagArrays'"
							>
							...
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (secret = !secret)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (secretMap = !secretMap)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (secretCondition = !secretCondition)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (hidden = !hidden)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
								<label class="unselectable">Parent Badge ID</label><input
									v-model="parent"
									type="text"
									autocomplete="off"
								/>
							...
							<li class="formControlRow fullWidth">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (overlay = !overlay)}><span></span></button
									>
								</div>
							</li>
								...
								<li class="formControlRow">
									...
									<div>
										<button
											...
											type="button"
											onclick={() => (overlayTypeMask = !overlayTypeMask)}><span></span></button
										>
									</div>
								</li>
								<li class="formControlRow">
									...
									<div>
										<button
											...
											type="button"
											onclick={() => (overlayTypeDual = !overlayTypeDual)}><span></span></button
										>
									</div>
								</li>
								<li class="formControlRow">
							...
							<li class="formControlRow">
								<label class="unselectable">Batch</label><input
									v-model="batch"
									type="number"
									min="0"
									autocomplete="off"
							...
							<li class="formControlRow">
								...
								<div>
									<button
										...
										:class="toggled: dev"
										type="button"
										onclick={() => (dev = !dev)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow">
						...
						<div class="subTabs badgeTagTabs" v-if="reqType === 'tagArrays' && currentTag">
							...
							<template v-for="(sibling, t) in tags">
								<div
									...
									onclick={() => (tagIndex = t)}
								>
									<small class="subTabLabel infoLabel unselectable"
										>[[sibling.tagId || '&lt;unnamed>']]</small
									>
									<div class="subTabBg"></div>
								</div>
							</template>
				...
				<template id="tagTemplate">
					<ul class="formControls flexFormControls">
						<li class="formControlRow fullWidth">
							<label class="unselectable">Tag ID</label><input
								v-model="tagId"
								type="text"
								autocomplete="off"
							/>
						...
						<li
							class="formControlRow fullWidth"
							v-if="$parent.reqType === 'tags' || $parent.reqType === 'tagArrays'"
						>
							<div class="textareaContainer">
							...
							<li class="formControlRow" :class=" fullWidth: mapCoords ">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (mapCoords = !mapCoords)}><span></span></button
									>
								</div>
							</li>
							...
							<li class="formControlRow" v-if="switchMode === 'switch'">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (switchValue = !switchValue)}><span></span></button
									>
								</div>
							</li>
								...
								<li class="formControlRow fullWidth" v-for="(switchId, s) in switchIds">
									...
									<div>
										<button
											...
											type="button"
											onclick={() => (switchValues[s] = !switchValues[s])}><span></span></button
										>
									</div>
								</li>
								<li class="formControlRow fullWidth">
							...
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (switchDelay = !switchDelay)}><span></span></button
									>
								</div>
							</li>
						</template>
							...
							<li class="formControlRow">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (varDelay = !varDelay)}><span></span></button
									>
								</div>
							</li>
							<li class="formControlRow" v-if="switchMode">
								...
								<div>
									<button
										...
										type="button"
										onclick={() => (varTrigger = !varTrigger)}><span></span></button
									>
								</div>
							</li>
						</template>
						<li
							...
							:class=" fullWidth: trigger === 'teleport' || trigger === 'coords' "
						>
						...
						<li class="formControlRow">
							...
							<div>
								<button
									...
									type="button"
									onclick={() => (timeTrial = !timeTrial)}><span></span></button
								>
							</div>
						</li>
						<li class="formControlRow">
		...
		<div id="confirmModalContainer" class="confirmModalContainer modalContainer hidden">
			<div id="confirmModal" class="confirmModal modal hidden">
				...
				<div class="modalFooter">
					<button
						class="confirmOkButton unselectable"
						type="button"
						data-i18n="[html]modal.confirm.ok">Ok</button
					>
					<button
						class="confirmCancelButton unselectable"
						type="button"
						data-i18n="[html]modal.confirm.cancel">Cancel</button
					>
				</div>
			</div>
			<div class="modalOverlay"></div>
	...
	<div>
		...
		<div class="notice">
			<a
				...
				data-i18n="[html]reviewRules">Review Rules</a
			>
			&bull;
			<a
				href="javascript:void(0);"
				onclick={() => openModal('warningsModal')}
				data-i18n="[html]reviewWarnings">Review Warnings</a
			>
		</div>
	</div>
